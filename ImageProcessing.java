...
public class ImageProcessing {
    ...
    public static int[][] sobelX = {{1, 2, 1}, {0, 0, 0}, {-1, -2, -1}};
    ...
    public static double[][] Conv1DTwoPass(int[][] img, double[] kernel, int width, int height, int kernelSize) {
        int row, col, i, radius = kernelSize / 2, newWidth = width + radius + radius,
                         newHeight = height + radius + radius;
        double pixel;
    ...
    public static double[][] Conv2D(int[][] img, double[][] kernel, int width, int height, int kernelSize) {
        int row, col, i, j, radius = kernelSize / 2, newWidth = width + radius + radius,
                            newHeight = height + radius + radius;
        double pixel;
        double[][] result = new double[width][height];
        double[][] paddedArr = ArrayHelper.Int2Double(PadBorder(img, radius, 'R', width, height), newWidth, newHeight);
    ...
    public static int[][] BilinearInterpolate(
            int[][] img, int inWidth, int inHeight, int tgWidth, int tgHeight, boolean inZeroPad) {
